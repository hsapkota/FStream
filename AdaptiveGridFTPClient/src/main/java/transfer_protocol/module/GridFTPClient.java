...
import client.utils.ProfilingThread;
...
//                    AdaptiveGridFTPClient.channelInUse.add(channel);
                    if(!channel.channnelConnectionFailed){
    ...
    */
    ...
    private void monitorChannels(int interval, Writer writer, Writer writer2, int timer) throws IOException {
        ...
        for (int i = 0; i < ftpClient.fileClusters.size(); i++) {
            ...
            if (throughputInMbps == 0) {
                ...
                System.out.println("Time: " + timer +
                        "\tChunk " + i + " " + chunk.getDensity().toString() +
                        "\t threads:" + xl.channels.size() +
                        "\t count:" + xl.count() +
        ...
        AdaptiveGridFTPClient.channelCounts.add(AdaptiveGridFTPClient.channelInUse.size());
        System.out.println("Total channel Count: " + AdaptiveGridFTPClient.channelInUse.size() +
