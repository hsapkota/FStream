...
//          }
  ...
  public static class ChannelPair {
    ...
    public boolean channnelConnectionFailed = false;
          ...
          switch (r.getCode()) {
            ...
            case 112:  // Progress marker
              if (pl != null) {
                ...
                try {
                  perfMarker = new PerfMarker(r.getMessage());
                  long diff = pl._markerArrived(perfMarker, e);
